...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2016 <a href=" {{ asset('https://adminlte.io') }}">Almsaeed Studio</a>.</strong>
        All rights
        reserved.
    </footer>
            ...
            <div class="tab-pane" id="control-sidebar-settings-tab">
                <form method="post">
                    ...
                    <div class="form-group">
                        <label class="control-sidebar-subheading">
                            Delete chat history
                            <a href="{{ asset('javascript:void(0)')}}" class="text-red pull-right"><i
    ...
    $(document).ready(function(){
        ...
        $('.create-cate-btn').on('click', function(){
            ...
            $.ajax({
                ...
                url: urlGet,
                success: function(data){
                    $('#createCateModal .modal-body').html(data);
        ...
        $('.edit-cate-btn').on('click', function(){
            ...
            $.ajax({
                ...
                url: urlGet,
                success: function(data){
                    $('#editCateModal .modal-body').html(data);
        ...
        $('.create-pro-btn').on('click', function(){
            var urlGet = $(this).data('url');
            $.ajax({
                type: "GET",
                url: urlGet,
                success: function(data){
                    $('#createProModal .modal-body').html(data);
                    $('#createProModal').modal('show');
                }, 
                error: function(xhr){
                    console.log(xhr);
                }
        ...
        $('.edit-pro-btn').on('click', function(){
            ...
            $.ajax({
                ...
                url: urlGet,
                success: function(data){
                    $('#editProModal .modal-body').html(data);
...
<script src="{{ asset('ckeditor_4.9.0_standard/ckeditor/ckeditor.js') }}"></script>
<script src="{{ asset('bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}"></script>
<script>
    CKEDITOR.replace('editor1', {
        filebrowserBrowseUrl: '{{ asset('ckfinder_php_3.4.2/ckfinder/ckfinder.html') }}',
        filebrowserImageBrowseUrl: '{{ asset('ckfinder_php_3.4.2/ckfinder/ckfinder.html?type=Images') }}',
        filebrowserFlashBrowseUrl: '{{ asset('ckfinder_php_3.4.2/ckfinder/ckfinder.html?type=Flash') }}',
        filebrowserUploadUrl: '{{ asset('ckfinder_php_3.4.2/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files') }}',
        filebrowserImageUploadUrl: '{{ asset('ckfinder_php_3.4.2/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images') }}',
        filebrowserFlashUploadUrl: '{{ asset('ckfinder_php_3.4.2/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash') }}'
    });
</script>
</body>
</html>
